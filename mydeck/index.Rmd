...
- R has several built in functions
  + These allow us to code common problems much more quickly
  
- For example, to get the absolute value of a number, we could use `abs()`

- We can look up the documentation for a function by typing `?` before it
